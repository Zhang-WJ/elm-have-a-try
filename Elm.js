	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Wrriten by'),
					_1: {
						ctor: '::',
						_0: A2(
...
var _user$project$Todo$viewControlsFilters = function (visibility) {
	return A2(
		...
		{
			ctor: '::',
			_0: A3(_user$project$Todo$visibilitySwap, '#/', 'All', visibility),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text(' '),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Todo$visibilitySwap, '#/active', 'Active', visibility),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(' '),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Todo$visibilitySwap, '#/completed', 'Completed', visibility),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_user$project$Todo$DeleteComplete),
					_1: {ctor: '[]'}
				}
			}
		},
...
var _user$project$Todo$viewControls = F2(
	function (visibility, entries) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Todo$viewControlsCount, entriesLeft),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Todo$viewControlsFilters, visibility),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Todo$viewControlsClear, entriesCompleted),
						_1: {ctor: '[]'}
					}
				}
			});
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											A2(_user$project$Todo$Check, todo.id, !todo.completed)),
										_1: {ctor: '[]'}
									}
								}
							}
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Todo$CheckAll(!allCompleted)),
										_1: {ctor: '[]'}
									}
								}
							}
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_user$project$Todo$UpdateField),
											_1: {
												ctor: '::',
												_0: _user$project$Todo$onEnter(_user$project$Todo$Add),
												_1: {ctor: '[]'}
											}
										}
									}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Todo$viewInput, model.field),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Todo$viewEntries, model.visibility, model.entries),
						_1: {
							ctor: '::',
							_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Todo$viewControls, model.visibility, model.entries),
							_1: {ctor: '[]'}
						}
					}
				}),
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							...
							entries: _elm_lang$core$String$isEmpty(model.field) ? model.entries : A2(
								...
								{
									ctor: '::',
									_0: A2(_user$project$Todo$newEntry, model.field, model.uid),
									_1: {ctor: '[]'}
								})
						}),
					{ctor: '[]'});
...
var _user$project$Todo$updateWithStorage = F2(
	function (msg, model) {
		var _p5 = A2(_user$project$Todo$update, msg, model);
		var newModel = _p5._0;
		var cmds = _p5._1;
		return {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					ctor: '::',
					_0: _user$project$Todo$setStorage(newModel),
					_1: {
						ctor: '::',
						_0: cmds,
						_1: {ctor: '[]'}
...
if (typeof _user$project$Todo$main !== 'undefined') {
    _user$project$Todo$main(Elm['Todo'], 'Todo', undefined);
}
